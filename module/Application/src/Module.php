...
class Module
{
    ...
    {
        $eventManager       = $event->getApplication()->getEventManager();  // Get event manager.
        $sharedEventManager = $eventManager->getSharedManager();            // Register the event listener method.
    ...
    {
        $controller     = $event->getTarget();  // Get controller and action to which the HTTP request was dispatched.
